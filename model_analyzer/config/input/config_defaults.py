...
DEFAULT_USE_LOCAL_GPU_MONITOR = False
...
DEFAULT_NGINX_LAUNCH_MODE = 'local'
DEFAULT_NGINX_DOCKER_IMAGE = 'nginx:1.21.1-alpine' 
DEFAULT_NGINX_HTTP_ENDPOINT = 'localhost:5000'
DEFAULT_NGINX_GRPC_ENDPOINT = 'localhost:5001'
DEFAULT_NGINX_SERVER_PATH = '/usr/sbin/nginx'
DEFAULT_NGINX_CONFIG_DIRECTORY = './nginx_conf'
DEFAULT_CB_SEARCH_ITERATIONS = 10
DEFAULT_CB_SEARCH_EXPLORATION = 'exploration'
DEFAULT_CB_SEARCH_EPSILON = 0.2
DEFAULT_CB_SEARCH_TAU = 2
DEFAULT_CB_SEARCH_POLICIES = 5
DEFAULT_CB_SEARCH_LAMBDA = 10
DEFAULT_CB_SEARCH_RND = 3
DEFAULT_CB_SEARCH_CONTEXTS = ['concurrency-range', 'batch-size']
DEFAULT_CB_SEARCH_ADF = False
DEFAULT_CB_SEARCH_ENCODE_CONTEXT_NUMERIC = False
DEFAULT_CB_SEARCH_ENCODE_ACTIONS_NUMERIC = False
DEFAULT_CB_SEARCH_NO_LEARN = False
DEFAULT_CB_SEARCH_PRETRAIN = True
